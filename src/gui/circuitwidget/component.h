...
class MAINMODULE_EXPORT Component
    : public QObject
    , public QGraphicsItem
{
    ...
    Q_PROPERTY(
        QString id READ idLabel WRITE setIdLabel DESIGNABLE true USER true)
    Q_PROPERTY(
        bool Show_id READ showId WRITE setShowId DESIGNABLE true USER true)
  ...
  public:
    ...
    {
        return QRectF(m_area.x() - 2, m_area.y() - 2, m_area.width() + 4,
                      m_area.height() + 4);
    }
    ...
    virtual void updateLabelsTheme();
